...
sudo cp -v context.xml /home/$USER/opt
sudo cp -v tomcat-users.xml /home/$USER/opt
cd /home/$USER/opt
...
sudo cp -v /home/$USER/opt/context.xml /home/$USER/opt/tomcat${version}/apache-tomcat-9.*/webapps/manager/META-INF/
sudo cp -v /home/$USER/opt/context.xml /home/$USER/opt/tomcat${version}/apache-tomcat-9.*/webapps/host-manager/META-INF/
sudo cp -v /home/$USER/opt/tomcat-users.xml /home/$USER/opt/tomcat${version}/apache-tomcat-9.*/conf/
sudo rm -rf /home/$USER/opt/context.xml
sudo rm -rf /home/$USER/opt/tomcat-users.xml
