...
sudo cp -v /home/$USER/tomcat-config-ubuntu/context.xml /home/$USER/opt/tomcat${version}/apache-tomcat-9.*/webapps/manager/META-INF/
sudo cp -v /home/$USER/tomcat-config-ubuntu/context.xml /home/$USER/opt/tomcat${version}/apache-tomcat-9.*/webapps/host-manager/META-INF/
sudo cp -v /home/$USER/tomcat-config-ubuntu/tomcat-users.xml /home/$USER/opt/tomcat${version}/apache-tomcat-9.*/conf/
sudo rm -rf /home/$USER/tomcat-config-ubuntu
cd /home/$USER/opt/tomcat${version}/apache-tomcat-9.*
sudo sh bin/startup.sh
echo "username: admin"
echo "password: admin"
sudo chown $USER:ubuntu /home/$USER/opt/tomcat${version}
sudo chown $USER:ubuntu /home/$USER/opt/tomcat${version}/apache-tomcat-9.*
